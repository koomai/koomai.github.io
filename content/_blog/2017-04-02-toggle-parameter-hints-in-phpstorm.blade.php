...
@section('post_body')
    ...
    <p>
        <img src="/assets/img/2017-04-02/parameter-hint-1.png" alt="Phpstorm Parameter Hints" class="img-responsive">
    </p>
    ...
    <p>
        <img src="/assets/img/2017-04-02/parameter-hint-2.png" alt="Phpstorm Parameter Hints" class="img-responsive">
    </p>
    
    Now you can easily toggle the feature on/off and use it only when required.

    <p>
        <img src="/assets/img/2017-04-02/parameter-hint-3.gif" alt="Phpstorm Parameter Hints" class="img-responsive">
    </p>
